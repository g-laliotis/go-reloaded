...
To add a new agent:
Create a file in internal/transformations/, e.g. newagent.go.
...
Register it in RunPipeline() inside pipeline.go.
Document it here with name, purpose, spec, and examples.
🧱 Document History
Date	Change
...
💡 Quick Summary
File	Purpose
🗂️ README.md	User guide — install, run, test
🧩 agents.md	Developer & auditor handbook — internal logic
Together, they make go-reloaded:
✅ Transparent ✅ Auditable ✅ Extendable ✅ Educational
🧠 Pro Tip:
When you change code, always update this document.
Keeping your specs aligned with implementation is what makes maintainable software.
📘 Part of the go-reloaded project.
© 2025 Giorgos Laliotis — Open Source under the MIT License.
