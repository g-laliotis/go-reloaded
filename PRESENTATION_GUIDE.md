...
4. **Docker**: Automated publishing to GitHub Container Registry (GHCR)
   - Images available at `ghcr.io/g-laliotis/go-reloaded:latest`
   - Automatic builds on every push and release
